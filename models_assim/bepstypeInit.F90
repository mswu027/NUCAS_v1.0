...
contains
  ...
  subroutine InitAssim()
    ...
    allocate(assim%p_res(PFT))
    allocate(assim%p_a(PFT))
    allocate(assim%p_Ksat_scalar(texture))
    allocate(assim%p_b_scalar(texture))
    allocate(assim%p_f_leaf(PFT))
    allocate(assim%p_VN_slope(PFT))
    allocate(assim%p_f_decay(PFT))
    allocate(assim%p_bwb(PFT))
    allocate(assim%p_b(PFT))
    allocate(assim%p_c(PFT))
    ...
    allocate(assim%u_res(PFT))
    allocate(assim%u_a(PFT))
    allocate(assim%u_Ksat_scalar(texture))
    allocate(assim%u_b_scalar(texture))
    allocate(assim%u_f_leaf(PFT))
    allocate(assim%u_VN_slope(PFT))
    allocate(assim%u_f_decay(PFT))
    allocate(assim%u_bwb(PFT))
    allocate(assim%u_b(PFT))
    allocate(assim%u_c(PFT))
