...
contains
  ...
  subroutine read_prior_para()
    implicit none
    integer  :: i,ncid,varid(30),ierr
    real(r8) :: p_Vcmax(PFT),p_q10(PFT),p_VJ_slope(PFT),p_sif_alpha(PFT),p_sif_beta(PFT),p_res(PFT)
    real(r8) :: p_Ksat_scalar(texture),p_b_scalar(texture)
    real(r8) :: p_f_leaf(PFT),p_VN_slope(PFT),p_f_decay(PFT),p_bwb(PFT),p_a(PFT),p_b(PFT),p_c(PFT)
    real(r8) :: u_Vcmax(PFT),u_q10(PFT),u_VJ_slope(PFT),u_sif_alpha(PFT),u_sif_beta(PFT),u_res(PFT)
    real(r8) :: u_Ksat_scalar(texture),u_b_scalar(texture)
    real(r8) :: u_f_leaf(PFT),u_VN_slope(PFT),u_f_decay(PFT),u_bwb(PFT),u_a(PFT),u_b(PFT),u_c(PFT)
    !--iLab::avoid pointer (see also below)
    ! type(para),pointer :: p
    character(len=255) :: fname
    ...
    call check(nf90_inq_varid(ncid,"p_res",varid(6)))
    call check(nf90_inq_varid(ncid,"p_a",varid(7)))
    ...
    call check(nf90_inq_varid(ncid,"p_VN_slope",varid(11)))
    call check(nf90_inq_varid(ncid,"p_f_decay",varid(12)))
    call check(nf90_inq_varid(ncid,"p_bwb",varid(13)))
    call check(nf90_inq_varid(ncid,"p_b",varid(14)))
    call check(nf90_inq_varid(ncid,"p_c",varid(15)))

    call check(nf90_inq_varid(ncid,"u_Vcmax",varid(16)))
    call check(nf90_inq_varid(ncid,"u_q10",varid(17)))
    call check(nf90_inq_varid(ncid,"u_VJ_slope",varid(18)))
    call check(nf90_inq_varid(ncid,"u_sif_alpha",varid(19)))
    call check(nf90_inq_varid(ncid,"u_sif_beta",varid(20)))
    call check(nf90_inq_varid(ncid,"u_res",varid(21)))
    call check(nf90_inq_varid(ncid,"u_a",varid(22)))
    call check(nf90_inq_varid(ncid,"u_Ksat_scalar",varid(23)))
    call check(nf90_inq_varid(ncid,"u_b_scalar",varid(24)))
    call check(nf90_inq_varid(ncid,"u_f_leaf",varid(25)))
    call check(nf90_inq_varid(ncid,"u_VN_slope",varid(26)))
    call check(nf90_inq_varid(ncid,"u_f_decay",varid(27)))
    call check(nf90_inq_varid(ncid,"u_bwb",varid(28)))
    call check(nf90_inq_varid(ncid,"u_b",varid(29)))
    call check(nf90_inq_varid(ncid,"u_c",varid(30)))
    ...
    call check(nf90_get_var(ncid,varid(6),p_res))
    call check(nf90_get_var(ncid,varid(7),p_a))
    ...
    call check(nf90_get_var(ncid,varid(11),p_VN_slope))
    call check(nf90_get_var(ncid,varid(12),p_f_decay))
    call check(nf90_get_var(ncid,varid(13),p_bwb))
    call check(nf90_get_var(ncid,varid(14),p_b))
    call check(nf90_get_var(ncid,varid(15),p_c))
    call check(nf90_get_var(ncid,varid(16),u_Vcmax))
    call check(nf90_get_var(ncid,varid(17),u_q10))
    call check(nf90_get_var(ncid,varid(18),u_VJ_slope))
    call check(nf90_get_var(ncid,varid(19),u_sif_alpha))
    call check(nf90_get_var(ncid,varid(20),u_sif_beta))
    call check(nf90_get_var(ncid,varid(21),u_res))
    call check(nf90_get_var(ncid,varid(22),u_a))
    call check(nf90_get_var(ncid,varid(23),u_Ksat_scalar))
    call check(nf90_get_var(ncid,varid(24),u_b_scalar))
    call check(nf90_get_var(ncid,varid(25),u_f_leaf))
    call check(nf90_get_var(ncid,varid(26),u_VN_slope))
    call check(nf90_get_var(ncid,varid(27),u_f_decay))
    call check(nf90_get_var(ncid,varid(28),u_bwb))
    call check(nf90_get_var(ncid,varid(29),u_b))
    call check(nf90_get_var(ncid,varid(30),u_c))
